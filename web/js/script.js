...
function mostrarObjetos(var1, var2){
    let libro={"codigo":var1, "nombre":var2}
    console.log(libro);
...
function mostrarObjetosClasicos(){
    ...
    libro.nombre='Angel Vargas';
    libro.codigo='0909-20-246';
    libro.correo='correo@umg.edu.gt';
    metodoAnidadoQueMuestraPorConsola(libro);
    eliminarPropiedadDeObjetos(libro);
}
...
function manipularElementosDelDom(){
    ...
    libro.codigo=codigo.value;
    libro.nombre=nombre.value;
    libro.correo=correo.value;
    console.log(libro);
    codigo.value='';
    nombre.value='';
    pasta.value='';
...
request.open('POST', 'ServletLibro', true);
